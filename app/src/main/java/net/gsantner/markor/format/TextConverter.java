...
public abstract class TextConverter {
    ...
    protected static final String HTML001_HEAD_WITH_BASESTYLE = "<html><head>" + CSS_S + "html,body{padding:4px 8px 4px 8px;font-family:'" + TOKEN_FONT + "';font-weight: 300; line-height: calc(30 / 18);}h1,h2,h3,h4,h5,h6{font-family:'sans-serif-condensed';}a{color:#0288d1;text-decoration:none;}img{height:auto;width:325px;margin:auto;}pre{background:#e0e0e0;padding:10px;border-radius:5px}blockquote em,h1,h2,h3,h4,strong,th{font-weight:600}h5,h6{font-weight:700}h1,h2{margin-top:calc((60 / 18) * 1rem);font-family:inherit}h1{margin-bottom:calc((60 / 18) * 1rem);font-size:calc((23 / 18) * 1rem);line-height:calc(30 / 23);text-transform:uppercase;letter-spacing:.5px; text-align:center;}h2{margin-bottom:calc((30 / 18) * 1rem);font-size:calc((21 / 18) * 1rem);line-height:calc(30 / 21)}h3,h4,h5,h6{margin-top:calc((30 / 18) * 1rem);font-size:1rem;font-family:inherit}h3,h4,h5{margin-bottom:0}h3,h4{line-height:calc(30 / 18)}h5,h6{line-height:normal}h1+:-webkit-any(h1,h2){margin-top:calc((45 / 18) * -1rem)}h2+:-webkit-any(h1,h2){margin-top:calc((15 / 18) * -1rem)}:-webkit-any(h1,h2,h3,h4,h5,h6)+:-webkit-any(h3,h4,h5,h6),body>h6:first-child{margin-top:0}blockquote,dl,figure,p,pre,table{margin:calc((30 / 18) * 1rem) auto 0}ol,ul{padding-left:15px}ul{list-style:none}ul>li:before{content:'• ';float:left;margin-left:calc((18 / 18) * -1rem)}strong{color:#e91e63;font-weight:800}em{color:#00838f;font-weight:800;font-style:normal}del{text-decoration:none;color:#6a1b9a;font-weight:800}" + CSS_E;    protected static final String HTML002_HEAD_WITH_STYLE_LIGHT = CSS_S + "html,body{color:#303030;}blockquote{color:#73747d;}" + CSS_E;
    ...
    protected static final String CSS_TABLE_STYLE = CSS_S + "table, th, td {  border: 1px solid " + TOKEN_BW_INVERSE_OF_THEME + "; width:100%;font-family:arial,sans-serif; border-collapse: collapse; border-spacing: 0; padding: 6px; } td,th{padding:8px;text-align:left;border-top:1px solid #dee2e6} tr:nth-child(odd){background-color:#f2f2f2}" + CSS_E;
